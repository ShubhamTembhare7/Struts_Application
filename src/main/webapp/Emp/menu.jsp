...
<script
   ...
   <%--  <body bgcolor="grey">
    ...
    <body bgcolor="grey">
        <button><html:link action="clayout.do?method=body">Home Page</html:link></button><br>
        <button><html:link action="clayout.do?method=mody">Display All Employee</html:link></button><br>
         <button><html:link action="clayout.do?method=insert">Insert Employee</html:link></button><br>
